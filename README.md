# Awesome LLM (Large Language Model) CLI (Command Line Interface)
...
[RunAPI CLI](https://github.com/runapi-ai/cli) - A JSON-first CLI for running AI image, video, music, audio, and LLM jobs from the terminal.
